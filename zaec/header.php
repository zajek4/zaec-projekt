...
<?php if ( $front ) : ?><noscript><style>#preloader,.scanlines,#cursorWrap,#rail,#holoCanvas{display:none!important}#heroPinSpace{height:auto!important}#heroPin{position:static!important;height:auto!important;overflow:visible!important}#holoWrap{display:block!important}.hero-grid{grid-template-columns:1fr!important;height:auto!important;padding-top:calc(var(--nav-h) + 56px)!important}.hero-copy,.hero-stage,.svc-panel{grid-area:auto!important}.hero-copy{order:1!important;opacity:1!important;transform:none!important}.hero-stage{order:2!important}.svc-panel{order:3!important;opacity:1!important;transform:none!important}#holoFallbackD{display:flex!important}.net-stage canvas{display:none!important}.net-outline{display:none!important}.net-fallback{display:flex!important}.net-cue{display:none!important}.net-copy>*{opacity:1!important;transform:none!important}</style></noscript><?php endif; ?>
<?php wp_head(); ?>
</head>
