...
<?php if ( $front ) : ?><noscript><style>#preloader,.scanlines,#cursorWrap,#rail,#holoCanvas,#earthCanvas{display:none!important}#heroPinSpace,#housePinSpace{height:auto!important}#heroPin,#housePin{position:static!important;height:auto!important;overflow:visible!important}#holoWrap,#earthHero{display:block!important}.hero-grid,.house-grid{grid-template-columns:1fr!important;height:auto!important;padding-top:calc(var(--nav-h) + 56px)!important}.hero-copy,.hero-stage,.svc-panel,.house-copy,.house-stage{grid-area:auto!important}.hero-copy,.house-copy{order:1!important;opacity:1!important;transform:none!important}.hero-stage,.house-stage{order:2!important}.svc-panel{order:3!important;opacity:1!important;transform:none!important}.house-pin-stage{display:block!important}#holoFallbackD,#earthFallbackD{display:flex!important}#earthLoader{display:none!important}</style></noscript><?php endif; ?>
<?php wp_head(); ?>
</head>
...
<aside id="rail" aria-label="<?php esc_attr_e( 'Sekcije stranice', 'zaec' ); ?>"><div class="rail-line" aria-hidden="true"><i id="railFill"></i></div><nav class="rail-dots"><?php foreach ( array('hero'=>'00','za-koga'=>'01','poznato'=>'02','house'=>'03','metoda'=>'04','proces'=>'05','ekran'=>'06','cijene'=>'07','radovi'=>'08','klijenti'=>'09','faq'=>'10','upit'=>'11') as $id=>$n ) : ?><a href="#<?php echo esc_attr($id); ?>" data-target="<?php echo esc_attr($id); ?>"<?php echo 'hero'===$id?' class="on"':''; ?>><i></i><span><?php echo esc_html($n); ?></span></a><?php endforeach; ?></nav><span id="railPct" aria-hidden="true">00</span></aside>
<?php endif; ?>
<header id="nav">
