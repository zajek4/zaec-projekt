...
<?php if ( $front ) : ?><noscript><style>#preloader,.scanlines,#cursorWrap,#rail,#holoCanvas{display:none!important}#holoWrap{display:block!important}.svc-panel,.hero-copy{opacity:1!important;transform:none!important}#holoFallbackD{display:flex!important}</style></noscript><?php endif; ?>
<?php wp_head(); ?>
</head>
