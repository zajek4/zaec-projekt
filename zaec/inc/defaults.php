...
function zaec_front_defaults() {
	return array(
		...
		'net_title'              => 'Netko upravo traži vašu uslugu na Googleu. Što pronalazi?',
		'net_lead'               => 'Web i Google profil koji jasno kažu što radite — prije nego vas nazovu.',
		'net_proof'              => 'Otvorite Google. Upišite svoju uslugu i grad. To je ono što vaš budući klijent vidi.',
		...
		'services_note_title'    => 'Google profil — postavljen kako treba, ne kao prazno obećanje.',
		'services_note'          => 'Popunimo usluge, radno vrijeme, lokaciju i kategorije ispravno. Rang i vidljivost ovise i o recenzijama i konkurenciji — to je proces, ne gumb. Mi dajemo čist temelj; ostalo raste s vremenom.',
		...
		'cijene_roi'             => 'Vaša usluga ima svoju cijenu. Web stranica od 390 € ili 690 € treba donijeti samo nekoliko poziva da se isplati. Kroz godinu dana — računajte sami.',
		...
		'studio_kicker'          => '[ 07.1 — Studio ]',
		'studio_title'           => 'Iskustvo iza ZAEC-a.',
		'studio_text'            => 'ZAEC izrađuje web stranice više od 10 godina. Iskustvo iz IT tvrtki u Hrvatskoj i SAD-u, preko 50 realiziranih projekata — od lokalnih obrtnika do ustanova. Kad projekt traži više, uključujemo provjerene partnere kako bi rezultat bio kompletan.',
...
function zaec_front_repeater_defaults() {
	return array(
		...
		'occupations' => array(
			array( 'tab' => 'Klima-servisi', 'title' => 'Za klima-servise', 'sub' => 'Servis, montaža i čišćenje. Vaš klijent treba lako vidjeti što radite, gdje dolazite i kako dogovoriti termin.', 'q' => 'Mali potez: usluge · područje rada · poziv/WhatsApp · termin', 'cta' => 'Pogledaj kako to izgleda za klima servis →', 'activity' => 'Klimatizacija, grijanje, hlađenje' ),
			array( 'tab' => 'Voda', 'title' => 'Za vodoinstalatere', 'sub' => 'Kod curenja nema vremena za navigaciju. Hitni kontakt, područje rada i vrsta intervencije moraju biti jasni odmah.', 'q' => 'Na webu: hitni poziv · intervencije · fotografija problema · lokalne stranice', 'cta' => 'Pogledaj kako web radi za vodoinstalatere →', 'activity' => 'Vodovod i instalacije' ),
			array( 'tab' => 'Struja', 'title' => 'Za električare', 'sub' => 'Od sitnog kvara do instalacija i atesta — jasno odvojimo usluge, reference i područje na koje izlazite.', 'q' => 'Mali potez: usluga po problemu · reference · područje rada · brzi upit', 'cta' => 'Pogledaj primjer za električare →', 'activity' => 'Elektrika' ),
			array( 'tab' => 'Krov', 'title' => 'Za krovopokrivače i limare', 'sub' => 'Krov se prodaje povjerenjem: izvedeni radovi, materijali, područje rada i jednostavan put do procjene.', 'q' => 'Mali potez: prije/poslije · materijali · područje rada · procjena', 'cta' => 'Pogledaj kako web radi za krovopokrivače →', 'activity' => 'Krovopokrivanje i limarija' ),
			array( 'tab' => 'Građevina', 'title' => 'Za građevinu i adaptacije', 'sub' => 'Kupac želi vidjeti što preuzimate, kako izgleda proces i možete li pokazati stvarne projekte prije prvog poziva.', 'q' => 'Na webu: projekti · usluge · proces · upit prema opsegu projekta', 'cta' => 'Pogledaj primjer za građevinu i adaptacije →', 'activity' => 'Građevina i adaptacije' ),
			array( 'tab' => 'Smještaj', 'title' => 'Za smještaj i turizam', 'sub' => 'Gost mora brzo vidjeti smještaj, lokaciju, sadržaje i najjednostavniji način rezervacije.', 'q' => 'Na webu: sobe · galerija · karta · rezervacija/upit · više jezika', 'cta' => 'Pogledaj kako web radi za smještaj i turizam →', 'activity' => 'Ugostiteljstvo, smještaj, turizam' ),
			array( 'tab' => 'Shop', 'title' => 'Za trgovine i webshopove', 'sub' => 'Proizvod mora biti lako pronaći, razumjeti i kupiti — posebno na mobitelu.', 'q' => 'Na webu: katalog/webshop · filteri · dostava i plaćanje · analitika', 'cta' => 'Pogledaj primjer za trgovine i webshopove →', 'activity' => 'Trgovina, proizvodnja, webshop' ),
			array( 'tab' => '+', 'title' => 'Za ostale usluge i struke', 'sub' => 'Odvjetnik, računovođa, ordinacija, studio, škola… Ako klijenti prije odluke uvijek pitaju isto, stranica može dati jasan odgovor i uputiti na poziv ili upit.', 'q' => 'Na webu: usluge · cijene/okvir · FAQ · jasan CTA — bez generičkog paketa', 'cta' => 'Pogledaj kako web radi za vašu djelatnost →', 'activity' => 'Uslužne djelatnosti' ),
		),
		'pain_points' => array(
		...
		'testimonials' => array(
			array( 'quote' => 'Stvarno sam zadovoljan, svaka čast. Promet je veći nego prije.', 'name' => 'Dominik', 'role' => 'Daj Gric', 'company' => 'Bilje' ),
		),
		'trust_stats' => array(
			array( 'value' => '50+', 'label' => 'realiziranih projekata' ),
