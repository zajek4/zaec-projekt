...
function zaec_front_field_groups() {
	return array(
		'Hero' => array(
			'hero_kicker' => array( 'label' => 'Kuća — kicker', 'type' => 'text' ),
			'hero_title' => array( 'label' => 'Kuća — H1', 'type' => 'textarea' ),
			'hero_lead' => array( 'label' => 'Kuća — lead', 'type' => 'textarea' ),
			'hero_primary_text' => array( 'label' => 'Kuća — primarni CTA', 'type' => 'text' ),
			'hero_primary_url' => array( 'label' => 'Kuća — primarni URL/anchor', 'type' => 'text' ),
			'hero_secondary_text' => array( 'label' => 'Kuća — sekundarni CTA', 'type' => 'text' ),
			'hero_secondary_url' => array( 'label' => 'Kuća — sekundarni URL/anchor', 'type' => 'text' ),
			'hero_note' => array( 'label' => 'Kuća — napomena ispod CTA-a', 'type' => 'text' ),
			'hero_hint' => array( 'label' => 'Kuća — 3D hint', 'type' => 'text' ),
		),
		'Earth hero' => array(
			'earth_kicker' => array( 'label' => 'Kicker', 'type' => 'text' ),
			'earth_title' => array( 'label' => 'H1', 'type' => 'textarea' ),
			'earth_lead' => array( 'label' => 'Lead', 'type' => 'textarea' ),
			'earth_primary_text' => array( 'label' => 'Primarni CTA — tekst', 'type' => 'text' ),
			'earth_primary_url' => array( 'label' => 'Primarni CTA — URL/anchor', 'type' => 'text' ),
			'earth_secondary_text' => array( 'label' => 'Sekundarni CTA — tekst', 'type' => 'text' ),
			'earth_secondary_url' => array( 'label' => 'Sekundarni CTA — URL/anchor', 'type' => 'text' ),
			'earth_note' => array( 'label' => 'Napomena ispod CTA-a', 'type' => 'text' ),
		),
