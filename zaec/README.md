...
- Stable orbital-information-flow implementation reissued as a clean release package.
- Planet remains first, Villa N remains second, and the marquee remains between the house and the first light section.
- Fixed camera, no mouse orbit/zoom, limited pooled information routes and destination ripples.
- Theme version: `1.9.9`.
